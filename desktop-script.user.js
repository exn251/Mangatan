...
async function exportImageToAnki(targetImg) {
    ...
    return new Promise((resolve) => {
        ...
        const confirmButton = createButton('âœ… Confirm Crop', '#2ecc71', '50%', '-60%');
        const cancelButton = createButton('âŒ Cancel', '#c0392b', '50%', '60%');
